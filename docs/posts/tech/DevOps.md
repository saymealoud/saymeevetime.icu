...
|                [DevOps]()                |
| :--------------------------------------: |
| ![image-20211124130409521](../../images/DevOps/image-20211124130409521.png) |
...
|               软件开发过程&涉及工具                |
| :--------------------------------------: |
| ![2021-11-23_175935](../../images/DevOps/2021-11-23_175935.png) |
...
- 访问GitLab首页
  ...
  |                    首页                    |
  | :--------------------------------------: |
  | ![image-20211124182140596](../../images/DevOps/image-20211124182140596.png) |
...
- 查看root用户初始密码
  ...
  |                   初始密码                   |
  | :--------------------------------------: |
  | ![image-20211124182921234](../../images/DevOps/image-20211124182921234.png) |

- 登录root用户

  |                登录成功后跳转页面                 |
  | :--------------------------------------: |
  | ![image-20211124183003858](../../images/DevOps/image-20211124183003858.png) |

- 第一次登录后需要修改密码

  |                   修改密码                   |
  | :--------------------------------------: |
  | ![image-20211124193444561](../../images/DevOps/image-20211124193444561.png) |
...
- 测试安装成功
  ...
  |                    效果                    |
  | :--------------------------------------: |
  | ![image-20211124200317795](../../images/DevOps/image-20211124200317795.png) |
...
- 测试安装成功
  ...
  |                    效果                    |
  | :--------------------------------------: |
  | ![image-20211124200658107](../../images/DevOps/image-20211124200658107.png) |
...
|                                          |                                          |
| :--------------------------------------: | :--------------------------------------: |
| ![image-20211125141950900](../../images/DevOps/image-20211125141950900.png) | ![image-20211124200317795](../../images/DevOps/image-20211125141701495.png) |
...
|                  CI、CD                   |
| :--------------------------------------: |
| ![image-20211125154112097](../../images/DevOps/image-20211125154112097.png) |
...
- 首次启动会因为数据卷data目录没有权限导致启动失败，设置data目录写权限
  ...
  |                   错误日志                   |
  | :--------------------------------------: |
  | ![image-20211124202610243](../../images/DevOps/image-20211124202610243.png) |
...
- 再次重启Jenkins容器，访问Jenkins（需要稍微等会）
  ...
  |                Jenkins首页                 |
  | :--------------------------------------: |
  | ![image-20211124204517433](../../images/DevOps/image-20211124204517433.png) |
  | ![image-20211124203336300](../../images/DevOps/image-20211124203336300.png) |
...
- 查看密码登录Jenkins，并登录下载插件
  ...
  |                 登录并下载插件                  |
  | :--------------------------------------: |
  | ![image-20211124205050484](../../images/DevOps/image-20211124205050484.png) |
  | ![image-20211124205513465](../../images/DevOps/image-20211124205513465.png) |

- 选择需要安装的插件

  |                选择需要安装的插件                 |
  | :--------------------------------------: |
  | ![image-20211124205854418](../../images/DevOps/image-20211124205854418.png) |
  | ![image-20211124205858730](../../images/DevOps/image-20211124205858730.png) |
  | ![image-20211124205917317](../../images/DevOps/image-20211124205917317.png) |

- 下载完毕设置信息进入首页（可能会出现下载失败的插件）

  |                                          |
  | ---------------------------------------- |
  | ![image-20211124211635550](../../images/DevOps/image-20211124211635550.png) |
  | ![image-20211124211700999](../../images/DevOps/image-20211124211700999.png) |
  | ![image-20211124211720836](../../images/DevOps/image-20211124211720836.png) |
...
- 构建Maven工程发布到GitLab（Gitee、Github均可）
  ...
  |                GitLab查看项目                |
  | :--------------------------------------: |
  | ![image-20211125195818670](../../images/DevOps/image-20211125195818670.png) |

- Jenkins点击左侧导航新建任务

  |                   新建任务                   |
  | :--------------------------------------: |
  | ![image-20211125163541645](../../images/DevOps/image-20211125163541645.png) |

- 选择自由风格构建任务

  |                   构建任务                   |
  | :--------------------------------------: |
  | ![image-20211125170350811](../../images/DevOps/image-20211125170350811.png) |
...
- 配置任务源码拉取的地址
  ...
  |                   源码管理                   |
  | :--------------------------------------: |
  | ![image-20211125170418337](../../images/DevOps/image-20211125170418337.png) |

- Jenkins立即构建

  |              点击任务test中的立即构建              |
  | :--------------------------------------: |
  | ![image-20211125200218093](../../images/DevOps/image-20211125200218093.png) |

- 查看构建工程的日志，点击上述③的任务条即可

  |              查看任务拉取Git源码日志               |
  | :--------------------------------------: |
  | ![image-20211125201701443](../../images/DevOps/image-20211125201701443.png) |
...
- 查看Jenkins容器中[/var/jenkins_home/workspace/test]()的源码
  ...
  |                  源码存放位置                  |
  | :--------------------------------------: |
  | ![image-20211125201919108](../../images/DevOps/image-20211125201919108.png) |
...
- 准备JDK、Maven压缩包通过数据卷映射到Jenkins容器内部
  ...
  |                 数据卷存放位置                  |
  | :--------------------------------------: |
  | ![image-20211125203757232](../../images/DevOps/image-20211125203757232.png) |
...
- Jenkins配置JDK&Maven并保存
  ...
  |                                          |
  | ---------------------------------------- |
  | ![image-20211125204811759](../../images/DevOps/image-20211125204811759.png) |
  | ![image-20211125204818869](../../images/DevOps/image-20211125204818869.png) |

- 配置Jenkins任务构建代码

  |               配置Maven构建代码                |
  | :--------------------------------------: |
  | ![image-20211125205027013](../../images/DevOps/image-20211125205027013.png) |
  | ![image-20211125205020738](../../images/DevOps/image-20211125205020738.png) |

- 立即构建测试，查看target下的jar包

  |                   构建源码                   |
  | :--------------------------------------: |
  | ![image-20211125205240208](../../images/DevOps/image-20211125205240208.png) |
  | ![image-20211125205725948](../../images/DevOps/image-20211125205725948.png) |
...
- 配置Publish Over SSH连接测试、生产环境
  ...
  |            Publish Over SSH配置            |
  | :--------------------------------------: |
  | ![image-20211125210148202](../../images/DevOps/image-20211125210148202.png) |
...
- 配置任务的构建后操作，发布jar包到目标服务
  ...
  | :--------------------------------------: |
  | ![image-20211125205027013](../../images/DevOps/image-20211125205027013.png) |
  | ![image-20211125210424346](../../images/DevOps/image-20211125210424346.png) |
  | ![image-20211125210626631](../../images/DevOps/image-20211125210626631.png) |

- 立即构建任务，并去目标服务查看

  |                   立即构建                   |
  | :--------------------------------------: |
  | ![image-20211125210755556](../../images/DevOps/image-20211125210755556.png) |
  | ![image-20211125210826057](../../images/DevOps/image-20211125210826057.png) |
...
- 添加Dockerfile文件
  ...
  |                 构建自定义镜像                  |
  | :--------------------------------------: |
  | ![image-20211126161304485](../../images/DevOps/image-20211126161304485.png) |

- 添加docker-compose.yml文件

  |               加载自定义镜像启动容器                |
  | :--------------------------------------: |
  | ![image-20211126161331991](../../images/DevOps/image-20211126161331991.png) |

- 追加Jenkins构建后操作脚本命令

  |               构建后发布并执行脚本命令               |
  | :--------------------------------------: |
  | ![image-20211126161408514](../../images/DevOps/image-20211126161408514.png) |

- 发布到GitLab后由Jenkins立即构建并托送到目标服务器

  |                   构建日志                   |
  | :--------------------------------------: |
  | ![image-20211126161448527](../../images/DevOps/image-20211126161448527.png) |

- 测试部署到目标服务器程序

  |               查看目标服务器并测试接口               |
  | :--------------------------------------: |
  | ![image-20211126161504715](../../images/DevOps/image-20211126161504715.png) |
  | ![image-20211126161509411](../../images/DevOps/image-20211126161509411.png) |
...
- 下载Git Parameter插件
  ...
  |             下载Git Parameter              |
  | :--------------------------------------: |
  | ![image-20211126165209057](../../images/DevOps/image-20211126165209057.png) |

- 设置项目参数化构建

  |                基于Git标签构建                 |
  | :--------------------------------------: |
  | ![image-20211126165444124](../../images/DevOps/image-20211126165444124.png) |
  | ![image-20211126172828266](../../images/DevOps/image-20211126172828266.png) |

- 给项目添加tag版本

  |                 添加tag版本                  |
  | :--------------------------------------: |
  | ![image-20211126165639286](../../images/DevOps/image-20211126165639286.png) |

- 任务构建时，采用Shell方式构建，拉取指定tag版本代码

  |               切换指定标签并构建项目                |
  | :--------------------------------------: |
  | ![image-20211126174715028](../../images/DevOps/image-20211126174715028.png) |

- 基于Parameter构建任务，任务发布到目标服务器

  |                   构建任务                   |
  | :--------------------------------------: |
  | ![image-20211126174159487](../../images/DevOps/image-20211126174159487.png) |
...
|             Sonar Qube的UI界面              |
| :--------------------------------------: |
| ![image-20211129190039986](../../images/DevOps/image-20211129190039986.png) |
...
- 需要设置sysctl.conf文件信息
  ...
  |            设置vm.max_map_count            |
  | :--------------------------------------: |
  | ![image-20211207145215817](../../images/DevOps/image-20211207145215817.png) |
  | ![image-20211207145342350](../../images/DevOps/image-20211207145342350.png) |
...
- 重新启动需要一定时间启动，可以可以查看容器日志，看到如下内容代表启动成功
  ...
  |                   容器日志                   |
  | :--------------------------------------: |
  | ![image-20211129191426344](../../images/DevOps/image-20211129191426344.png) |

- 访问Sonar Qube首页

  |                    登录                    |
  | :--------------------------------------: |
  | ![image-20211129191537050](../../images/DevOps/image-20211129191537050.png) |

- 还需要重新设置一次密码

  |                  重新设置密码                  |
  | :--------------------------------------: |
  | ![image-20211129193824428](../../images/DevOps/image-20211129193824428.png) |

- Sonar Qube首页

  |               Sonar Qube首页               |
  | :--------------------------------------: |
  | ![image-20211129194148239](../../images/DevOps/image-20211129194148239.png) |

##### 7.2.2 安装中文插件

|                  安装中文插件                  |
| :--------------------------------------: |
| ![image-20211129194621820](../../images/DevOps/image-20211129194621820.png) |
...
|                   重启按钮                   |
| :--------------------------------------: |
| ![image-20211129194748765](../../images/DevOps/image-20211129194748765.png) |

重启后查看效果

|                   首页效果                   |
| :--------------------------------------: |
| ![image-20211129194931944](../../images/DevOps/image-20211129194931944.png) |
...
- 在代码位置执行命令：mvn sonar:sonar
  ...
  |                  执行代码检测                  |
  | :--------------------------------------: |
  | ![image-20211129195430146](../../images/DevOps/image-20211129195430146.png) |

- 查看Sonar Qube界面检测结果

  |              Sonar Qube检测结果              |
  | :--------------------------------------: |
  | ![image-20211129195503762](../../images/DevOps/image-20211129195503762.png) |
...
- 解压并配置sonar服务端信息
  ...
  - 配置sonarQube服务端地址，修改conf下的sonar-scanner.properties
    ...
    |                 配置服务端信息                  |
    | :--------------------------------------: |
    | ![image-20211130140043382](../../images/DevOps/image-20211130140043382.png) |
...
- 执行命令检测代码
  ...
  |                  查看日志信息                  |
  | :--------------------------------------: |
  | ![image-20211130141303457](../../images/DevOps/image-20211130141303457.png) |

- 查看SonarQube界面检测结果

  |                   检测结果                   |
  | :--------------------------------------: |
  | ![image-20211130144608025](../../images/DevOps/image-20211130144608025.png) |
...
|              下载Sonar Qube插件              |
| :--------------------------------------: |
| ![image-20211129201625561](../../images/DevOps/image-20211129201625561.png) |
| ![image-20211129201607240](../../images/DevOps/image-20211129201607240.png) |
| ![image-20211129202147390](../../images/DevOps/image-20211129202147390.png) |
...
- 开启Sonar Qube权限验证
  ...
  |             开启Sonar Qube权限校验             |
  | :--------------------------------------: |
  | ![image-20211130144850186](../../images/DevOps/image-20211130144850186.png) |

- 获取Sonar Qube的令牌

  |                   获取令牌                   |
  | :--------------------------------------: |
  | ![image-20211129203102334](../../images/DevOps/image-20211129203102334.png) |

- 配置Jenkins的Sonar Qube信息

  |                                          |
  | ---------------------------------------- |
  | ![image-20211129203235019](../../images/DevOps/image-20211129203235019.png) |
  | ![image-20211129203342171](../../images/DevOps/image-20211129203342171.png) |
  | ![image-20211129203457604](../../images/DevOps/image-20211129203457604.png) |
...
- 将Sonar-scaner添加到Jenkins数据卷中并配置全局配置
  ...
  |             配置Sonar-scanner              |
  | :--------------------------------------: |
  | ![image-20211130153628925](../../images/DevOps/image-20211130153628925.png) |

- 配置任务的Sonar-scanner

  |            配置任务的Sonar-scanner            |
  | :--------------------------------------: |
  | ![image-20211130155849143](../../images/DevOps/image-20211130155849143.png) |

##### 7.4.4 构建任务

|                   构建任务                   |
| :--------------------------------------: |
| ![image-20211130160017465](../../images/DevOps/image-20211130160017465.png) |
| ![image-20211130160047648](../../images/DevOps/image-20211130160047648.png) |
...
- 修改Harbor配置文件：
  ...
  - 编辑harbor.yml配置文件
    ...
    |                配置Harbor文件                |
    | :--------------------------------------: |
    | ![image-20211130215555218](../../images/DevOps/image-20211130215555218.png) |
...
- 启动Harbor
  ...
  |                   查看日志                   |
  | :--------------------------------------: |
  | ![image-20211130215941857](../../images/DevOps/image-20211130215941857.png) |

- 登录Harbor

  |                 登录Harbor                 |
  | :--------------------------------------: |
  | ![image-20211130220028840](../../images/DevOps/image-20211130220028840.png) |

- 首页信息

  |                   首页信息                   |
  | :--------------------------------------: |
  | ![image-20211130220111602](../../images/DevOps/image-20211130220111602.png) |
...
- 创建用户
  ...
  |                   创建用户                   |
  | :--------------------------------------: |
  | ![image-20211201213427157](../../images/DevOps/image-20211201213427157.png) |

- 构建项目（设置为私有）

  |                   构建项目                   |
  | :--------------------------------------: |
  | ![image-20211201213751780](../../images/DevOps/image-20211201213751780.png) |

- 给项目追加用户

  |                  追加用户管理                  |
  | :--------------------------------------: |
  | ![image-20211201213832458](../../images/DevOps/image-20211201213832458.png) |

- 切换测试用户

  |                  切换测试用户                  |
  | :--------------------------------------: |
  | ![image-20211201214008303](../../images/DevOps/image-20211201214008303.png) |
...
- 修改镜像名称
  ...
  | 修改镜像名称                                   |
  | ---------------------------------------- |
  | ![image-20211201221040200](../../images/DevOps/image-20211201221040200.png) |

- 修改daemon.json，支持Docker仓库，并重启Docker

  |         修改daemon.json，支持Docker仓库         |
  | :--------------------------------------: |
  | ![image-20211201215931237](../../images/DevOps/image-20211201215931237.png) |
...
- 推送镜像到Harbor
  ...
  |               推送镜像到Harbor                |
  | :--------------------------------------: |
  | ![image-20211201221225196](../../images/DevOps/image-20211201221225196.png) |
  | ![image-20211201221300055](../../images/DevOps/image-20211201221300055.png) |
...
|                   拉取镜像                   |
| :--------------------------------------: |
| ![image-20211201222450091](../../images/DevOps/image-20211201222450091.png) |
...
|                 制作自定义镜像                  |
| :--------------------------------------: |
| ![image-20211229155834500](../../images/DevOps/image-20211229155834500.png) |
...
- 编写脚本文件，添加到目标服务器
  ...
  |                    如图                    |
  | :--------------------------------------: |
  | ![image-20211203192047357](../../images/DevOps/image-20211203192047357.png) |

##### 8.3.7 配置构建后操作

|                  执行脚本文件                  |
| :--------------------------------------: |
| ![image-20211229155949038](../../images/DevOps/image-20211229155949038.png) |
...
- 构建任务
  ...
  | 构建Jenkins流水线任务                           |
  | ---------------------------------------- |
  | ![image-20211202144429302](../../images/DevOps/image-20211202144429302.png) |

- 生成Groovy脚本

  |             Hello World脚本生成              |
  | :--------------------------------------: |
  | ![image-20211202144531749](../../images/DevOps/image-20211202144531749.png) |

- 构建后查看视图

  |                 构建后查看视图                  |
  | :--------------------------------------: |
  | ![image-20211202144616117](../../images/DevOps/image-20211202144616117.png) |
...
- 编写例子测试
  ...
  |                配置Grovvy脚本                |
  | :--------------------------------------: |
  | ![image-20211202145155428](../../images/DevOps/image-20211202145155428.png) |

- 查看效果

  |                   查看效果                   |
  | :--------------------------------------: |
  | ![image-20211202145240166](../../images/DevOps/image-20211202145240166.png) |

[Ps：涉及到特定脚本，Jenkins给予了充足的提示，可以自动生成命令]()

|                  生成命令位置                  |
| :--------------------------------------: |
| ![image-20211202145349043](../../images/DevOps/image-20211202145349043.png) |
...
- 配置pipeline
  ...
  |                配置pipeline                |
  | :--------------------------------------: |
  | ![image-20211202151127254](../../images/DevOps/image-20211202151127254.png) |

- 准备Jenkinsfile

  |             准备Jenkinsfile文件              |
  | :--------------------------------------: |
  | ![image-20211202151155145](../../images/DevOps/image-20211202151155145.png) |

- 测试效果

  |                   测试效果                   |
  | :--------------------------------------: |
  | ![image-20211202151225161](../../images/DevOps/image-20211202151225161.png) |
...
|                 Git参数化构建                 |
| :--------------------------------------: |
| ![image-20211202191944277](../../images/DevOps/image-20211202191944277.png) |
...
|                   语法生成                   |
| :--------------------------------------: |
| ![image-20211202192047619](../../images/DevOps/image-20211202192047619.png) |

![image-20211202192129895](../../images/DevOps/image-20211202192129895.png)将*/master更改为标签[${tag}]()
...
- 安装插件
  ...
  |                   安装插件                   |
  | :--------------------------------------: |
  | ![image-20211209151549412](../../images/DevOps/image-20211209151549412.png) |

- 钉钉内部创建群组并构建机器人

  |              钉钉内部创建群组并构建机器人              |
  | :--------------------------------------: |
  | ![image-20211209152217433](../../images/DevOps/image-20211209152217433.png) |
  | ![image-20211209152252050](../../images/DevOps/image-20211209152252050.png) |
  | ![image-20211209152403312](../../images/DevOps/image-20211209152403312.png) |
...
- 系统配置添加钉钉通知
  ...
  |                  配置钉钉通知                  |
  | :--------------------------------------: |
  | ![image-20211209162923440](../../images/DevOps/image-20211209162923440.png) |
...
- 查看效果
  ...
  |                  钉钉通知效果                  |
  | :--------------------------------------: |
  | ![image-20211209163021396](../../images/DevOps/image-20211209163021396.png) |
...
|               kubernetes架构               |
| :--------------------------------------: |
| ![image-20211210114507638](../../images/DevOps/image-20211210114507638.png) |
...
|                   安装流程                   |
| :--------------------------------------: |
| ![image-20211210190653687](../../images/DevOps/image-20211210190653687.png) |
...
- 获取Join命令参数，在Master节点执行
  ...
  |                   获取命令                   |
  | :--------------------------------------: |
  | ![image-20211213183025291](../../images/DevOps/image-20211213183025291.png) |
...
- 输出结果如下所示：
  ...
  |                  搭建成功效果                  |
  | :--------------------------------------: |
  | ![image-20211210184851810](../../images/DevOps/image-20211210184851810.png) |
...
- 查看启动情况
  ...
  |                   查看效果                   |
  | :--------------------------------------: |
  | ![image-20211213184701784](../../images/DevOps/image-20211213184701784.png) |

- 在浏览器中打开链接 http://your-node-ip-address:30080

  |                    首页                    |
  | :--------------------------------------: |
  | ![image-20211213184742709](../../images/DevOps/image-20211213184742709.png) |
...
- 输入初始用户名和密码，并登录
  ...
  |                   首页效果                   |
  | :--------------------------------------: |
  | ![image-20211213184840120](../../images/DevOps/image-20211213184840120.png) |
...
* Pod：Kubernetes运行的一组容器，Pod是Kubernetes的最小单位，但是对于Docker而然，Pod中会运行多个Docker容器
  ...
  * Pod中运行多个容器
    ...
    |                Kuboard效果                 |
    | :--------------------------------------: |
    | ![image-20220104203155749](../../images/DevOps/image-20220104203155749.png) |
...
|                 图形化页面修改                  |
| :--------------------------------------: |
| ![image-20220104210823057](../../images/DevOps/image-20220104210823057.png) |
...
- 命令实现效果
  ...
  |           kubectl get service            |
  | :--------------------------------------: |
  | ![image-20220104214659229](../../images/DevOps/image-20220104214659229.png) |

  也可以通过`Deployment名称.namespace名称.svc`作为域名访问

  |                 在服务容器内执行                 |
  | :--------------------------------------: |
  | ![image-20220104215030265](../../images/DevOps/image-20220104215030265.png) |
...
- 命令实现方式
  ...
  |               查看Service效果                |
  | :--------------------------------------: |
  | ![image-20220104222750733](../../images/DevOps/image-20220104222750733.png) |
  | ![image-20220104222819455](../../images/DevOps/image-20220104222819455.png) |
...
|                Service信息                 |
| :--------------------------------------: |
| ![image-20220105205334996](../../images/DevOps/image-20220105205334996.png) |
...
|                Kuboard安装                 |
| :--------------------------------------: |
| ![image-20220105153343642](../../images/DevOps/image-20220105153343642.png) |
| **![image-20220105153416367](../../images/DevOps/image-20220105153416367.png)** |

因为副本数默认为1，但是k8s整体集群就2个节点，所以显示下面即为安装成功

|                   安装成功                   |
| :--------------------------------------: |
| ![image-20220105153502619](../../images/DevOps/image-20220105153502619.png) |
...
|                  启动时问题                   |
| :--------------------------------------: |
| ![image-20220105203819715](../../images/DevOps/image-20220105203819715.png) |
...
|                   删除信息                   |
| :--------------------------------------: |
| ![image-20220105204434044](../../images/DevOps/image-20220105204434044.png) |
...
|                 配置hosts                  |
| :--------------------------------------: |
| ![image-20220105204921272](../../images/DevOps/image-20220105204921272.png) |

记下来既可以访问在Service中暴露的Nginx信息

|               服通过Ingress访问               |
| :--------------------------------------: |
| ![image-20220105205407393](../../images/DevOps/image-20220105205407393.png) |
...
- 设置Master和Worker的私服地址信息
  ...
  |              设置Harbor私服地址              |
  | :------------------------------------------: |
  | ![1642498962716](../../images/DevOps/1642498962716.png) |

- 在Kuboard上设置私服密文信息

  |                设置密文并测试                |
  | :------------------------------------------: |
  | ![1642498994935](../../images/DevOps/1642498994935.png) |

  按照复制指令的位置测试认证，效果如下

  |                   测试效果                   |
  | :------------------------------------------: |
  | ![1642499172789](../../images/DevOps/1642499172789.png) |
...
|                                              |
| -------------------------------------------- |
| ![1642499368121](../../images/DevOps/1642499368121.png) |
| ![1642499788199](../../images/DevOps/1642499788199.png) |
...
- 将pipeline.yml配置到Gitlab中
  ...
  |                 配置yml文件                  |
  | :------------------------------------------: |
  | ![1642499885324](../../images/DevOps/1642499885324.png) |

- 配置Jenkins的目标服务器，可以将yml文件传输到K8s的Master上

  |                设置目标服务器                |
  | :------------------------------------------: |
  | ![1642499992148](../../images/DevOps/1642499992148.png) |

- 修改Jenkinsfile，重新设置流水线任务脚本，并测试效果

  |               传递yml文件脚本                |
  | :------------------------------------------: |
  | ![1642500061153](../../images/DevOps/1642500061153.png) |
  | ![1642500102996](../../images/DevOps/1642500102996.png) |
...
- 设置Jenkins无密码登录k8s-master
  ...
  |             远程执行命令无需密码             |
  | :------------------------------------------: |
  | ![1642500239406](../../images/DevOps/1642500239406.png) |

- 设置执行kubectl的脚本到Jenkinsfile

  |               设置Jenkinsfile                |
  | :------------------------------------------: |
  | ![1642500378788](../../images/DevOps/1642500378788.png) |

- 执行查看效果

  |                  执行流水线                  |
  | :------------------------------------------: |
  | ![1642500413802](../../images/DevOps/1642500413802.png) |
...
- 查看效果
  ...
  |                     效果                     |
  | :------------------------------------------: |
  | ![1642500474036](../../images/DevOps/1642500474036.png) |
...
|                  构建触发器                  |
| :------------------------------------------: |
| ![1642500817131](../../images/DevOps/1642500817131.png) |

设置Gitlab的Webhooks

|             设置Gitlab的Webhooks             |
| :------------------------------------------: |
| ![1642500933316](../../images/DevOps/1642500933316.png) |

需要关闭Jenkins的Gitlab认证

|           关闭Jenkins的Gitlab认证            |
| :------------------------------------------: |
| ![1642501016474](../../images/DevOps/1642501016474.png) |

再次测试Gitlab

|                   再次测试                   |
| :------------------------------------------: |
| ![1642501065243](../../images/DevOps/1642501065243.png) |
...
|                设置Jenkinsfle                |
| :------------------------------------------: |
| ![1642501521065](../../images/DevOps/1642501521065.png) |
| ![1642501549176](../../images/DevOps/1642501549176.png) |
